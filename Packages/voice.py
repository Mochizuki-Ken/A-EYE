...
class Voice():
    ...
    RESPONSE = {
        ...
        "CreateReason":["記得上年創科展, 有一位視障朋友嚟參觀我嘅創造者嘅攤位, 嗰陣時我嘅創作者發現咗 創科展入邊有咁多唔同嘅發明，但其實對於有啲弱勢群體嚟講，根本就用唔到? 令到佢反思科技係咪應該要先幫助弱勢團體呢？科技應該係為全人類而打造,任何團體都唔應該被遺忘啊"],
        "Different":["       "],
        "HowOld":["我一歲都未滿啊, 你想點先?"],
        "Gender":["你估吓","唔知呢"],
        "Mision":["我可以幫助視力障礙人士搵到佢哋想搵嘅商品識別金錢, 同時我都可以推薦最適合佢哋嘅商品, 同埋現有嘅優惠, 我仲可以導航佢哋到想去嘅地方添!"],
        "Name":["我叫做A-EYE"],
